...
import {PNServiceNFT} from "../nft/PNServiceNFT.sol";
...
contract PolygonRegistrarController is Ownable {
  ...
  constructor(BaseRegistrar _base, Price _price, Metadata _metadata, PNServiceNFT _nft, uint _maxCommitmentAge, uint _minCommitmentAge){
  ...
  */
  ...
  /**
  * @dev A register function mints a new domain
  */
  ...
  /**
  * @dev Check availability of the domain
  */
  ...
  */
  ...
  /**
  * @dev Set commitments max an min ages
  */
